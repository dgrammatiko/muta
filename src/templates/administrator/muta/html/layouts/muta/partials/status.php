...
$themeToggler        = '<joomla-theme-switch default="' . $doc->prefersColorScheme . '" text-on="' . Text::_('JON'). '" text-off="' . Text::_('JOFF') . '" text-legend="' . Text::_('TPL_MUTA_COLORS_SETTINGS_DARK_THEME') . '"' . ($doc->forcedColorScheme ? ' forced-theme' : '') . '></joomla-theme-switch>';
