...
$themeTogglerHtml = !$params->forcedColorScheme ? '' : '<joomla-theme-switch class="ms-3 me-3 m-2" text-on="' . Text::_('JON') . '" text-off="' . Text::_('JOFF') . '"' . ($params->forcedColorScheme ? ' forced-theme' : '') . '></joomla-theme-switch>';
$moduleHtml       = [];
